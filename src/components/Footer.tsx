      ...
      <footer className="text-gray-600 body-font bg-black mt-20">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <Image
              src="/image.png" // Path to your image in the public folder
              alt="WanderWays Logo"
          ...
          <p className="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-700 sm:py-2 sm:mt-0 mt-4">
            © 2020 WanderWays —
            <a
              href="https://www.linkedin.com/in/nashra-zahid-290173308?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app "
